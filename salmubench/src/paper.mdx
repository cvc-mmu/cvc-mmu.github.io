...
SALMUBench is built on a synthetic dataset of fictitious personas associated with sensitive private information such as names, locations, email addresses, phone numbers, and financial identifiers. Images are identity-preserving synthetic portraits, and captions are paraphrased to create semantically varied associations, making unlearning harder than simple string removal.
...
<div class="mx-auto max-w-md">
  <Figure>
    ...
    <Fragment slot="caption">Diagram illustrating the splits and subsets of the [SALMUBench evaluation dataset](https://huggingface.co/datasets/cvc-mmu/salmubench-512-redistributed).</Fragment>
  </Figure>
</div>
...
Overall, our benchmark shows that utility-efficient deletion is feasible, but no current method fully solves the trade-off between precise forgetting and collateral damage.
