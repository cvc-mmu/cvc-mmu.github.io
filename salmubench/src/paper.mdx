...
links:
  - name: Paper
    url: https://openaccess.thecvf.com/content/CVPR2026/papers/Selvas-Sala_SALMUBench_A_Benchmark_for_Sensitive_Association-Level_Multimodal_Unlearning_CVPR_2026_paper.pdf
  ...
  - name: CVPR Page
    url: https://cvpr.thecvf.com/virtual/2026/poster/38042
    icon: fa:share
  # - name: Leaderboard
  #   url: 
